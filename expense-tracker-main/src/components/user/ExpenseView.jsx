...
//       }
//     //  if (result.isConfirmed) {
//     //   removeExpense(expense._id); // ✅ sirf UI se remove karenge
//     //   toast.success("Expense removed from UI");
//     }
//   }

//   return (
//     <div className=" grey:bg-neutral-900 dark:text-neutral-100 hover:bg-neutral-100 hover:cursor-pointer relative w-[calc(33%-16px)] mx-auto bg-white rounded-2xl shadow-lg p-5 flex flex-col items-center gap-4 hover:shadow-xl transition">
//       {/* Image/Icon */}
//       <img
...
//           className=" cursor-pointer p-2 w-7 h-7 bg-gray-300 hover:bg-black rounded-full"
//           size={20}
//         />
//         <BsPencilSquare
