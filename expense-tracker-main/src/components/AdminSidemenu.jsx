...
import { FaRegUser, FaUsers, FaEye } from "react-icons/fa";
...
const [menuItems, setMenuItems] = useState([
     { name: "User Detail", icon: <FaRegUser />, path: "/admin/user" },
  { name: "Charts", icon: <FcMoneyTransfer />, path: "/admin/chart" },
  { name: "User Visit", icon: <FaEye />, path: "/admin/visit" },
